...
export function FlightNote({ sessionId }: { sessionId: string }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h3 className="text-[13px] uppercase tracking-wide text-muted">What it isolated</h3>
        <p className="mt-1 text-[16px] leading-relaxed">{body.what_it_isolated}</p>
      </div>
      <div>
        <h3 className="text-[13px] uppercase tracking-wide text-muted">What the contrast shows</h3>
        <p className="mt-1 text-[16px] leading-relaxed">{body.what_the_contrast_shows}</p>
      </div>
      <div>
        <h3 className="text-[13px] uppercase tracking-wide text-muted">Carry forward</h3>
        <p className="mt-1 text-[16px] leading-relaxed">{body.what_to_carry_forward}</p>
      </div>
    </div>
  )
}
